						...
						<Table>
							...
							{COST_MULTIPLIERS.map((row, index) => (
								...
								>
									...
									<TableCell align='right'>{row.multiplier_type}</TableCell>
				...
				<div>
					...
					<div className='flex flex-col gap-2 w-96 mt-2 ml-2'>
						<div className='flex justify-between'>
							...
							<div className='font-bold'>{SPACING.WALKWAY_WIDTH} ft</div>
						</div>
						<div className='flex justify-between'>
							<div>Transformer Gap</div>
							<div className='font-bold'>{SPACING.TRANSFORMER_GAP} ft</div>
						</div>
						<div className='flex justify-between'>
							<div>Storage Gap</div>
							<div className='font-bold'>{SPACING.STORAGE_GAP} ft</div>
						</div>
						<div className='flex justify-between'>
							<div>Max Device Width</div>
							<div className='font-bold'>{SPACING.MAX_DEVICE_WIDTH} ft</div>
						</div>
						<div className='flex justify-between'>
							<div>Max System Width</div>
							<div className='font-bold'>{SPACING.MAX_SYSTEM_WIDTH} ft</div>
						</div>
						<div className='flex justify-between'>
							<div>Outer Offset</div>
							<div className='font-bold'>{SPACING.OUTER_OFFSET} ft</div>
						</div>
					</div>
				</div>
			</div>
